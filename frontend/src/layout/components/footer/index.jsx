      ...
      <Row align="middle" justify="space-between">
        <Col md={8} span={24}>
          {/* <p className="hp-badge-text hp-font-weight-600 hp-mb-0 hp-text-color-dark-30">
            COPYRIGHT @{ new Date().getFullYear()} Linkhub Fyp, All rights Reserved
          </p> */}
        </Col>
        <Col md={8} span={24}>
          {/* <p className="hp-badge-text hp-font-weight-600 hp-mb-0 hp-text-color-dark-30">
            email:  &nbsp; 
            <a className="hp-badge-text hp-font-weight-600 hp-mb-0 hp-text-color-dark-30" href = "mailto:info@Linkhub Fyp.ch">info@Linkhub Fyp.ch </a>
          </p> */}
        </Col>
        <Col md={8}>
            {/* <p className="hp-badge-text hp-font-weight-600 hp-mb-0 hp-text-color-dark-30">
