    ...
    renderItem={(item) => (
      <List.Item>
        <List.Item.Meta
          ...
          description="Yoda Design, a design language for background applications, is refined by Linkhub Fyp UED Team"
        />
      </List.Item>
    )}
  />
...
for (let i = 0; i < 23; i++) {
  listData.push({
    ...
    avatar: user,
    description:
      "Yoda Design, a design language for background applications, is refined by Linkhub Fyp UED Team",
    content:
